...
public class Menu {
        ...
        while (continuar) {
            switch (opcion) {
                ...
                case 2:
                    ...
                    jugadorActivo.getInventario().getListaElemento()
    ...
    public void iniciarJuego(int progreso) {
        ...
        ObjetoCasa oAux1 = null;
        ObjetoCasa oAux2 = null;
        ObjetoCasa oAux3 = null;
        ObjetoCasa oAux4 = null;
        ObjetoCasa oAux5 = null;

        PistaTexto pAux1 = null;
        PistaTexto pAux2 = null;
        PistaTexto pAux3 = null;
        PistaTexto pAux4 = null;
        try {
            ...
            System.out.println("Error al cargar datos estáticos del juego: " + e.getMessage());
            return;
        }
        ...
        while (continuar) {
            switch (progreso) {
                case 0:
                    System.out.println("=== Inventario ANTES de agregar en case ===");
                    jugadorActivo.getInventario().getListaElemento()
                            .forEach(e -> System.out.println(e.getId() + " - " + e.getNombre()));
